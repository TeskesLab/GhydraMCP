...
public class RawImageHeightSettingsDefinition implements NumberSettingsDefinition {

    private static final String STORAGE_KEY = "raw_image_height";
    private static final String DISPLAY_NAME = "Image Height";
    private static final String DESCRIPTION = "Image height in pixels for raw image data types";
    private static final BigInteger MAX_VALUE = BigInteger.valueOf(0xFFFF);
    private static final int DEFAULT = 0;

    public static final RawImageHeightSettingsDefinition DEF = new RawImageHeightSettingsDefinition();

    private RawImageHeightSettingsDefinition() {}
